          ...
          <v-row justify="center">
            <v-col cols="12">
              ...
              <h3 class="font-weight-light mt-3">
                ...
                work of the service. Best regards, the Facts Lover team.
              </h3>
              <h3 class="font-weight-light mt-3">
              ...
              <h3 class="font-weight-light mt-3">
                Email:
                <a href="mailto: factslover012@gmail.com">
                  factslover012@gmail.com
                </a>
              </h3>
              <h3 class="font-weight-light mt-3">
                We in telegram:
                <a href="https://t.me/factslover" target="_blank">
                  Facts Lover Telegram
                </a>
              </h3>
            </v-col>
          </v-row>
